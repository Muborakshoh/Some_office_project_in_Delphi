...
WDoc:=Wapp.Documents.Add(ExtractFilePath(Application.ExeName)+'¿Õ ≈“ÕÕ€≈ ƒ¿ÕÕ€≈ –¿¡Œ“Õ» ¿.dotx');
...
{WDoc:=Wapp.Documents.Add(ExtractFilePath(Application.ExeName)+'¿Õ ≈“ÕÕ€≈ ƒ¿ÕÕ€≈.dotx');
  // WApp.Visible:=True;
