...
begin
   ...
   WDoc:=WApp.Documents.Add(ExtractFilePath(Application.ExeName)+'Анкетаа.dotx');
...
begin
  Wapp:=CreateOLEObject('Word.Application');
  Wdoc:=Wapp.Documents.Open(ExtractFilePath(Application.ExeName)+'25.02.2023_''Математика'' .docx');
  Wapp.Visible:=true;
  Tab:=Wdoc.Tables.Item(1);
...
ComboBox1.Items.Add('Информатика');
ComboBox1.Items.Add('Химия');
ComboBox1.Items.Add('Английский язык');
ComboBox1.Items.Add('Русский язык');
ComboBox1.Items.Add('История');
ComboBox2.Items.Add('ПМиИ');
ComboBox2.Items.Add('ХФММ');
ComboBox2.Items.Add('Геология');
ComboBox2.Items.Add('МО');
ComboBox2.Items.Add('ГМУ');
ComboBox2.Items.Add('Лингвистика');
